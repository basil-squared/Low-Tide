...
It's Simple! All you have to do is either...

### File Selection

```bash
low_tide -f file.flac
```
...
And directories arent much harder!

```bash
low_tide -d music_directory
```

It even searches your subdirectories too!
